...
public class Grouping {
	...
	public void groupingByExample(){
		 ...
		 * accumulating them.
		 */	
		Map<String, Set<String>> countriesByContinentAndByPopulation = countryStream
				.collect(groupingBy(Country::getContinent, mapping(country -> {
					if (country.getPopulation() >= 30000000L)
						return "higlypopulated";
					else
						return "lesspopulated";
		...
		System.out.println(countriesByContinentAndByPopulation);
/*		Here the transformation function passed to the mapping method maps a Country into its String
		The resulting stream of CaloricLevels is then passed to a toSet collector, just like toList one, 
		but accumulating the elements of a stream into a Set. You can use toCollection(HashSet::new) if
		you want instance of HashSet */
